...
export const translations = {
  en: {
    ...
    forgotPasswordSubtitle: "Enter your registered email and we'll send you a secure password reset link.",
    sendResetLinkBtn: 'Send Reset Link',
    sendingLink: 'Sending link...',
    resetLinkSentTitle: 'Check Your Email',
    resetLinkSentDesc: 'We have sent a secure password reset link to your email address.',
    devDirectLinkNotice: 'Development Mode Link (Click to test directly):',
    ...
    passwordResetSuccessDesc: 'Your password has been reset successfully. You can now log in with your new credentials.',
    goToLogin: 'Proceed to Sign In',
    invalidResetLink: 'Invalid or missing reset token in link. Please request a new one.',
  ...
  bn: {
    ...
    forgotPasswordSubtitle: 'আপনার নিবন্ধিত ইমেইল দিন, আমরা একটি নিরাপদ পাসওয়ার্ড রিসেট লিংক পাঠিয়ে দেব।',
    sendResetLinkBtn: 'রিসেট লিংক পাঠান',
    sendingLink: 'লিংক পাঠানো হচ্ছে...',
    resetLinkSentTitle: 'আপনার ইমেইল চেক করুন',
    resetLinkSentDesc: 'আমরা আপনার ইমেইল ঠিকানায় একটি নিরাপদ পাসওয়ার্ড রিসেট লিংক পাঠিয়েছি।',
    devDirectLinkNotice: 'লোকাল ডেভেলপমেন্ট লিংক (সরাসরি টেস্ট করতে ক্লিক করুন):',
    backToLogin: 'লগইনে ফিরে যান',
    resetPasswordTitle: 'নতুন পাসওয়ার্ড সেট করুন',
    resetPasswordSubtitle: 'নিচে আপনার নতুন পাসওয়ার্ড লিখুন ও নিশ্চিত করুন।',
    newPasswordLabel: 'নতুন পাসওয়ার্ড',
    confirmPasswordLabel: 'নতুন পাসওয়ার্ড নিশ্চিত করুন',
    passwordsDoNotMatch: 'দুটি পাসওয়ার্ড মিলছে না। পুনরায় যাচাই করুন।',
    resetPasswordSubmit: 'পাসওয়ার্ড পরিবর্তন করুন',
    resettingPassword: 'পাসওয়ার্ড পরিবর্তন হচ্ছে...',
    passwordResetSuccessTitle: 'পাসওয়ার্ড সফলভাবে পরিবর্তিত হয়েছে!',
    passwordResetSuccessDesc: 'আপনার পাসওয়ার্ড সফলভাবে রিসেট সম্পন্ন হয়েছে। এখন নতুন পাসওয়ার্ড দিয়ে লগইন করুন।',
    goToLogin: 'লগইন পেজে যান',
    invalidResetLink: 'লিংকে ভুল বা মেয়াদোত্তীর্ণ টোকেন পাওয়া গেছে। অনুগ্রহ করে আবার চেষ্টা করুন।',
