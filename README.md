...
5. **👑 ইউজার রোল ও কন্ট্রোল সেন্টার (Admin & Editor):**
   - **ডিফল্ট এডিটর রোল:** সাইন-আপ করার সময় প্রতিটি নতুন অ্যাকাউন্ট স্বয়ংক্রিয়ভাবে `editor` রোল লাভ করে (ব্যবহারকারী নিজে নিজে অ্যাডমিন হতে পারে না)।
   - **নেভবার রোল ইন্ডিকেটর:** নেভবারে দৃশ্যমান `👑 Admin` অথবা `✏️ Editor` ব্যাজ।
   - **অ্যাডমিন পোর্টাল (`/admin`):** শুধুমাত্র অ্যাডমিনগণ অন্য ব্যবহারকারীদের রোল পরিবর্তন, সাসপেন্ড/এক্টিভেট, সরাসরি ইউজার তৈরি এবং সিস্টেমের সমস্ত ফর্ম তদারকি করতে পারেন।
   - **রোল-ভিত্তিক পারমিশন (RBAC):** অ্যাডমিনদের সিস্টেমের যেকোনো ফর্ম, রেসপন্স ও এক্সেল ডাউনলোড দেখার পূর্ণ ক্ষমতা।

6. **🔑 পাসওয়ার্ড রিসেট ও ইমেইল ভেরিফিকেশন (Forgot/Reset Password):**
   - নিবন্ধিত ইমেইলে সুরক্ষিত ক্রিপ্টোগ্রাফিক টোকেন সহ ১ ঘণ্টার মেয়াদযুক্ত রিসেট লিংক প্রেরণ।
   - Nodemailer দিয়ে নির্ভরযোগ্য ইমেইল ডেলিভারি (SMTP ও লোকাল প্রিভিউ সমর্থন)।
   - নতুন পাসওয়ার্ড নিশ্চিতকরণ ও Bcrypt ১২ সল্ট রাউন্ডে নিরাপদ হ্যাশিং।

7. **🔗 সোশ্যাল শেয়ার মডাল (WhatsApp, Messenger, Email):**
   - এক ক্লিকে লিংক কপি এবং সরাসরি WhatsApp, Messenger ও Email-এ শেয়ার।
   - ডিভাইসের নেটিভ শেয়ার শিট সমর্থন।

8. **🌐 সম্পূর্ণ দ্বিভাষিক সমর্থন (EN / BN):**
   - সম্পূর্ণ ইংরেজি ও বাংলা ভাষা টগল।

9. **🔤 Google Sans টাইপোগ্রাফি:**
   - অ্যাপ্লিকেশনের সর্বত্র প্রিমিয়াম গুগল সান্স (Google Sans / Product Sans) ফন্ট।

10. **🔐 সর্বোচ্চ নিরাপত্তা (Maximum Security):**
